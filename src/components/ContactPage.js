      ...
      <div>
        ...
        <div className="contact__content">
          ...
          >
            ...
            <p className="subheading contact__form-header">
              Please fill out the quick form and we'll get in touch with you
              shortly!
            </p>
          ...
          <div className="contact__alternatives">
            <h2 className="contact__alternatives-heading">
              Other Ways To Connect
            </h2>
            <p className="subheading">
              You can also contact us on these platforms
            </p>
            ...
            <ul className="contact__list">
              <li className="contact__list-item">
                Email:{" "}
                <a href="mailto:lead.dscnus@gmail.com">lead.dscnus@gmail.com</a>
              </li>
            </ul>
          </div>
        </div>
